                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col text-end">
                                ...
                                <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#profils">
                                    Perbarui Profil
                                </button>
                            </div>
                        </div>
...
<!-- Modal -->
<div class="modal fade" id="profils" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="<?= BASEURL ?>profil/ubah/<?= $_SESSION['user_id'] ?>" method="post">
